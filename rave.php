...
class Rave extends NonmerchantGateway
{
     ...
     */
    private static $authors = array(array('name' => "Flutterwave Developers",
     ...
     */
    private $test_url = 'https://api.flutterwave.com';
    /**
     * @var string The URL to use when communicating with the live Rave API
     */
    private $live_url = 'https://api.flutterwave.com';
    ...
    public function buildProcess(array $contact_info, $amount, array $invoice_amounts = null, array $options = null)
    {
        ...
        $params = [
            ...
            'meta' => [
                'clientID' => $contact_info['client_id'],
                'invoices' => $invoices
            ],
        ];
...
//		$callback_data = json_decode($post['resp']);
        ...
        return ['client_id' => $this->ifSet($client_id),
            'amount' => $this->ifSet($data->amount),
            'currency' => $this->ifSet($data->currency),
            'status' => $this->ifSet($data->status) == 'successful' ? 'approved' : 'declined', // we wouldn't be here if it weren't, right?
            'reference_id' => null,
            'transaction_id' => $this->ifSet($data->tx_ref),
     ...
     */
    public
    function success(array $get, array $post)
    {
        ...
        // verify transaction
        $id = $this->ifSet($get['transaction_id']);
        $result = $api->checkPayment($id);
        $data = $result->data();
     ...
     */
    public
    function capture($reference_id, $transaction_id, $amount, array $invoice_amounts = null)
    {
     ...
     */
    public
    function void($reference_id, $transaction_id, $notes = null)
    {
     ...
     */
    public
    function refund($reference_id, $transaction_id, $amount, $notes = null)
    {
